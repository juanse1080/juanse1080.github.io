...
const images = [
   ...
   },
   {
      key: "plataforma_tic",
      img: plataforma_tic,
      title: "Plataforma TIC",
      date: "Feb 1, 2019 - Oct 31, 2020",
      location: "Bucaramanga, Santander",
      role: "FullStack",
      entity: "IPRED UIS",
      description: [
         "Al iniciar mi instancia con el IPRED comencé como desarrollador fullStack, empezando con la adaptación del software para la migración de la base de datos. Ademas se desarrollaron multiples vistas administrativas para el manejo de la información de los estudiantes y profesores.",
