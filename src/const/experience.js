const experience = {
  espanol: [
    ...
    {
      title: "AUXILIAR DOCENTE",
      date: "Enero 2019 - Mayo 2019",
      institution: "UIS",
      description: [
        "Contribución al desarrollo de una plataforma Navbar-PSI, una pagina para la gestión de prótesis a medida.",
      ],
      ended: true,
  ...
  english: [
    ...
    },
    {
      ...
      institution: "UIS",
      description: [
        "Contribution to the development of a Navbar-PSI platform, a page for the management of custom prostheses.",
      ],
      ended: true,
      techs: ["Python 3.5", "Django 2.1", "Javascript", "React JS", "MySQL"],
    },
