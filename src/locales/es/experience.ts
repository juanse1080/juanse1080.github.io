export default {
  ...
  sections: {
    ...
    bitnovo:
      "Desarrollo y optimización del frontend de Bitnovo, una plataforma especializada en el comercio de criptomonedas, implementando funcionalidades modernas y eficientes para mejorar la experiencia de compra y transacción de los usuarios.",
    "binary-groups":
      "Liderazgo en el desarrollo de una plataforma web integral que unifica múltiples canales de e-commerce, como Mercado Libre, Shopify y Marketplace, con el objetivo de mejorar la gestión y optimización de las ventas en línea a través de un enfoque centralizado.",
    mayasoft:
      "Desarrollo de plataformas para la optimización de la programación de pilotos y la automatización de procesos empresariales, incluyendo la generación automatizada de contratos legales mediante RPA (Automatización Robótica de Procesos), mejorando la eficiencia operativa y reduciendo errores humanos.",
  },
} as const;
